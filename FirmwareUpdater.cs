...
using InnovasubBSL430;
using System.Threading;
using System.IO;

namespace IWU___PC_Inteface
{
    ...
    */
    public class FirmwareUpdater
    {
        ...
        public string FirmwareBinary
        { get; set; }
        private bool AutoStartUpdate;

        public FirmwareUpdater(string firmwareStr, bool autoStartUpdate)
        {
        ...
        /// <returns></returns>
        public static FirmwareUpdater FromTextHexFile(string filename)
        {
            string str = File.ReadAllText(filename);
            return new FirmwareUpdater(str, true);
        }
        ...
        private void firmwareUpgradeWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            BinaryTextFileParser ram_bsl  = new BinaryTextFileParser(Resource.RAM_BSL00078838);
            ...
            cmd = BSLCoreCommandParser.LoadPC(0x00002504);
            usbBSL.write(cmd);
